...
//Use for login debug (takes a lot of screenshots)
test('login på lm-shop-frontend-git-develop-lemvigh-muller.vercel.app', async ({ page }) => {
    ...
    // Screenshot 2: After Vercel auth
